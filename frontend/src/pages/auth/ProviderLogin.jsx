...
export default function ProviderLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // TODO: call authService.loginProvider(email, password) once the backend is ready
    console.log('provider login submitted')
  }
  ...
  return (
    <div className="min-h-screen bg-primaryLight flex items-center justify-center px-6 font-body text-ink">
      <div className="w-full max-w-sm bg-white border border-line rounded-2xl p-8">
        ...
        <h1 className="font-display font-600 text-2xl text-ink">Provider login</h1>
        <p className="text-sm text-sub mt-1 mb-6">Manage your bookings and jobs.</p>
